...
# TODO: Ensure this is the correct GitHub homepage where releases can be downloaded for terraspace.
...
list_all_versions() {
  ...
  # Change this function if terraspace has other means of determining installable versions.
  list_github_tags
}
